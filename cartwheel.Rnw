...
Formally speaking, the task consists in establishing $p(\{K_{\text{pre}},\theta_{\text{b,pre}},\sigma_{\text{pre}},K_{\text{post}},\theta_{\text{b,post}},\sigma_{\text{post}}\}\mid D)$
where $D$ now stands for the union of the pre- and post-installation
data $D_{\text{pre}}$ and $D_{\text{post}}$.
