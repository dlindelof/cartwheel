...
6 years of the program. A baseline, established as a linear model
in HDD, CDD, relative humidity and energy price, was fitted to a random
sample of 150 houses among the 730 that participated in 2003. No uncertainties
are reported.\citet{Kaiser2010} 
\end{itemize}
