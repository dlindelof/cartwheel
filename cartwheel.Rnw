...
\author[nb]{David~Lindel?f\corref{cor1}}

\ead{david.lindelof@neurobat.net}

\author[nb]{Mohammad~Alisafaee}

\author[nb]{Pierluca~Bors?}
...
bulbs) to major projects (better fa?ade insulation), an owner will
...
from trivial (replacing light bulbs) to major projects (better fa?ade
...
commonly referred to as Neubau, B?ro, and Wohnung, the latter two
...
(right) parts of the Sargans building. The B?ro and Wohnung circuits
