...
building owner in Switzerland in number of buildings. They have publicly
committed themselves to ``save double the amount of CO\textsubscript{2}
generated by our entire operations and supply chain'' for themselves
and their customers by 2020, and to ``increase our own energy efficiency
by a further 35\% between 2016 and 2020'' (\citet{swisscom2016}).
Like many major Swiss companies, their stock of buildings includes
a majority of systems heated by non-renewable fuel and ECMs that help
these buildings become more efficient are particularly attractive.
In late 2015, a pilot study was started to evaluate the effectiveness
