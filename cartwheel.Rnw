...
TK buildings in Switzerland and is one of the major building owner.
They have publicly committed themselves to ``save double the amount
of CO\textsubscript{2} generated by our entire operations and supply
...
A commercial model-predictive controller called NOL\textsuperscript{a}(Neurobat
OnLine\textemdash analog) \citep{neurobat2017} was selected
