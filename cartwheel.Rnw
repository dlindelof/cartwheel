...
Appendix. We import it in a form suitable for data analysis.
...
# workaround for https://r-forge.r-project.org/tracker/?func=detail&group_id=1228&aid=6465&atid=4864
print(x = xtable(transform(oilReadingsDf, Date = as.character(Date))),
      booktabs = TRUE,
